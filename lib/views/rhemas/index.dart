    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(
            DateHelper.formatDate(rhemaDate, 'dd MMM y'),
            style: TextStyle(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      SizedBox(height: 30),
                      Text(
                        'No Rhema item found for selected date',
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          TextButton(
                            child: Text(
                              DateHelper.formatDate(rhemaDate),
                              style: TextStyle(
                                fontSize: 18.0,
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      TextButton(
                                          onPressed: () => pickDate(context),
                                          child: Text(
                                            DateHelper.formatDate(DateTime.parse(snapshot.data[index].summaryDate), 'dd MMM yyyy'),
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      Align(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            String summary = generateRhemaSummary(snapshot.data[index].rhemas);
                                        ...
                                        child: InkWell(
                                          onTap: () async {
                                            showDeleteConfirmation(context).then(
                                              (answer) {
                                                if (answer) {
                                                  RhemaModule.deleteRhema(snapshot.data[index].rhemas).then((_) {
                                                    setState(() {
